...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private final static String KEY_SHARED_PREFERENCES = "cube_ptr_classic_last_update";
    ...
    private View mSuccess; //味之道自增成功图标
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mSuccess = header.findViewById(R.id.ptr_classic_header_success_view);//味之道自增成功图标
        resetView();
    }
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        mProgressBar.setVisibility(INVISIBLE);
        mSuccess.setVisibility(INVISIBLE);//味之道自增
    ...
    private String getLastUpdateTime() {
        ...
        if (mLastUpdateTime == -1 && !TextUtils.isEmpty(mLastUpdateTimeKey)) {
            mLastUpdateTime = getContext().getSharedPreferences(KEY_SHARED_PREFERENCES, 0)
