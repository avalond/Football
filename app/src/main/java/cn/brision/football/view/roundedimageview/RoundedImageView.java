...
package cn.brision.football.view.roundedimageview;
...
import static cn.brision.football.view.roundedimageview.RoundedDrawable.CORNER_BOTTOM_LEFT;
import static cn.brision.football.view.roundedimageview.RoundedDrawable.CORNER_BOTTOM_RIGHT;
import static cn.brision.football.view.roundedimageview.RoundedDrawable.CORNER_TOP_LEFT;
import static cn.brision.football.view.roundedimageview.RoundedDrawable.CORNER_TOP_RIGHT;
...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerRadii[CORNER_TOP_LEFT] = a.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_top_left,
            -1);
        mCornerRadii[CORNER_TOP_RIGHT] = a.getDimensionPixelSize(
            R.styleable.RoundedImageView_riv_corner_radius_top_right, -1);
        mCornerRadii[CORNER_BOTTOM_RIGHT] = a.getDimensionPixelSize(
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundedDrawable) {
            ((RoundedDrawable) drawable).setScaleType(mScaleType).setBorderWidth(mBorderWidth).setBorderColor(
                mBorderColor).setOval(mIsOval).setTileModeX(mTileModeX).setTileModeY(mTileModeY);
    ...
    public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
        if (mCornerRadii[CORNER_TOP_LEFT] == topLeft && mCornerRadii[CORNER_TOP_RIGHT] == topRight &&
            mCornerRadii[CORNER_BOTTOM_RIGHT] == bottomRight && mCornerRadii[CORNER_BOTTOM_LEFT] == bottomLeft) {
            return;
        }
