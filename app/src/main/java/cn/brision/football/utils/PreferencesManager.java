...
/**
 * Created by wangchengcheng on 16/8/22.
...
public class PreferencesManager {
    ...
    private static String shareName = "SHRAE_DATA";
    ...
    /**
     * 使用SharedPreferences,存储boolean型的值
     *
     * @param key
     * @param value
     */
    ...
    /**
     * 使用SharedPreferences,存储String型的值
     *
     * @param key
     * @param value
     */
    ...
    /**
     * 使用SharedPreferences,存储float型的值
     *
     * @param key
     * @param value
     */
    ...
    /**
     * 使用SharedPreferences,存储string的set集合
     *
     * @param key
     * @param value
     */
        ...
        try {
            ...
            if (edit != null) {
                ...
                for (Method method : methods) {
                    merhodName = method.getName();
                    for (Field f : fields) {
                        fieldName = f.getName();
                        if (merhodName.toLowerCase().contains(fieldName.toLowerCase())) {
    ...
    public void setLanguage(String Langusge) {
        instance.put(LANG, Langusge);
    }
