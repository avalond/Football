...
public class MediaController extends FrameLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    private TextView mTimeTxt;//总播放时间
    private TextView mTimeTxt1;//播放时间
    ...
    public void setPlayProgressTxt(int nowSecond, int allSecond) {
        ...
        mTimeTxt1.setText(getPlayTime(nowSecond));
    }
    ...
    private void initView(Context context) {
        ...
        mTimeTxt1 = (TextView) findViewById(R.id.time1);
    ...
    private String getPlayTime(int playSecond) {
    ...
    private String getPlayTimeall(int allSecond) {
